...
DOMAIN = dict(x=50, y=32, extrapolation=extrapolation.combine_sides(x=(extrapolation.ConstantExtrapolation((1, 0)), extrapolation.BOUNDARY), y=extrapolation.ZERO))
DT = 1.0
BOUNDARY_MASK = StaggeredGrid(Box[:0.5, :], **DOMAIN)
